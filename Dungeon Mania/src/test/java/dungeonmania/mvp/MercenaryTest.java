...
public class MercenaryTest {
    ...
    public void testMercenaryCannotBeSameAsPlayer() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_mercenaryTest_PotionMovement",
    ...
    @Test
    @Tag("12-7")
    @DisplayName("Testing an allied mercenary move to player next position")
    public void moveNextPosition() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_mercenaryTest_bribeAmount", "c_mercenaryTest_allyMovement");
